...
//        [Tooltip("Event: Primary Touched")]
//        [HideInInspector] public UnityEvent OnPrimaryButtonTouch = new UnityEvent();

//        [Tooltip("Event: Primary Touched")]
//        [HideInInspector] public UnityEvent OnPrimaryButtonUntouch = new UnityEvent();
...
//        [Tooltip("Event: Secondary Touched")]
//        [HideInInspector] public UnityEvent OnSecondaryButtonTouch = new UnityEvent();

//        [Tooltip("Event: Secondary Touched")]
//        [HideInInspector] public UnityEvent OnSecondaryButtonUntouch = new UnityEvent();
...
//        [Tooltip("Event: Primary 2D Axis Touch")]
//        [HideInInspector] public UnityEvent OnPrimary2DAxisTouch = new UnityEvent();

//        [Tooltip("Event: Primary 2D Axis Untouch")]
//        [HideInInspector] public UnityEvent OnPrimary2DAxisUntouch = new UnityEvent();
...
//                if (TryGetFeatureValue(CommonUsages.trigger, out _triggerValue))
//                {
...
//                // Capture grip value
//                if (TryGetFeatureValue(CommonUsages.grip, out _gripValue))
//                {
...
//                if (TryGetFeatureValue(CommonUsages.primary2DAxis, out _primary2DAxisValue))
//                {
...
//                if (TryGetFeatureValue(CommonUsages.primary2DAxisTouch, out _primary2DAxisTouch))
//                {
...
//                if (_secondary2DAxisLeft) Secondary2DAxisLeftAction = true;
//                else Secondary2DAxisLeftAction = false;

//                // Capture secondary 2D Axis
//                if (TryGetFeatureValue(CommonUsages.secondary2DAxis, out _secondary2DAxisValue))
//                {
...
//                // Capture trigger button
//                if (TryGetFeatureValue(CommonUsages.triggerButton, out _triggerButton))
//                {
...
//                // Capture trigger button
//                if (TryGetFeatureValue(CommonUsages.trigger, out var triggerValueTmp))
//                {
...
//                // Capture grip button
//                if (TryGetFeatureValue(CommonUsages.gripButton, out _gripButton))
//                {
...
//                if (TryGetFeatureValue(CommonUsages.primary2DAxisClick, out _primary2DAxisButton))
//                {
...
//                if (TryGetFeatureValue(CommonUsages.secondary2DAxisClick, out _secondary2DAxisButton))
//                {
...
//                if (TryGetFeatureValue(CommonUsages.primaryButton, out _primaryButton))
//                {
//                    if (_primaryButton) PrimaryButtonAction = true;
//                    else PrimaryButtonAction = false;
//                }

//                if (TryGetFeatureValue(CommonUsages.primaryTouch, out _primaryButtonTouch))
//                {
...
//                if (TryGetFeatureValue(CommonUsages.secondaryButton, out _secondaryButton))
//                {
//                    if (_secondaryButton) SecondaryButtonAction = true;
//                    else SecondaryButtonAction = false;
//                }

//                if (TryGetFeatureValue(CommonUsages.secondaryTouch, out _secondaryButtonTouch))
//                {
...
//                // Capture menu button
//                if (TryGetFeatureValue(CommonUsages.menuButton, out _menuButton))
//                {
...
//        }
//#if UNITY_EDITOR || UNITY_STANDALONE_WIN
//        SteamVR_Input_Sources _handSteamVR;
//#endif
//        bool _isOpenVR = false;
//        Dictionary<InputFeatureUsage<bool>, string> _buttonMappingsBool;
//        Dictionary<InputFeatureUsage<float>, string> _buttonMappingsFloat;
//        Dictionary<InputFeatureUsage<Vector2>, string> _buttonMappings2D;

//        private bool TryGetFeatureValue(InputFeatureUsage<bool> button, out bool value)
//        {
//            // UpdateMapping();
...
//                    return false;
//                else
//                    value = SteamVR_Input.GetState("default", _buttonMappingsBool[button], _handSteamVR);
//            else
//#endif
//                return device.TryGetFeatureValue(button, out value);

//            return true;
//        }

//        private bool TryGetFeatureValue(InputFeatureUsage<float> button, out float value)
//        {
//            // UpdateMapping();
...
//                    return false;
//                else
//                    value = SteamVR_Input.GetSingle("default", _buttonMappingsFloat[button], _handSteamVR);
//            else
//#endif
//            return device.TryGetFeatureValue(button, out value);
...
//        private bool TryGetFeatureValue(InputFeatureUsage<Vector2> button, out Vector2 value)
//        {
//            // UpdateMapping();
...
//                    return false;
//                else
//                    value = SteamVR_Input.GetVector2("default", _buttonMappings2D[button], _handSteamVR);
//            else
//#endif
//            return device.TryGetFeatureValue(button, out value);
...
//        {
//            if (_buttonMappingsBool == null || _buttonMappingsBool.Count == 0)
//            {

//#if UNITY_EDITOR || UNITY_STANDALONE_WIN
//                _handSteamVR = Hand == XRNode.RightHand ? SteamVR_Input_Sources.RightHand : SteamVR_Input_Sources.LeftHand;
//                _isOpenVR = SteamVR.initializedState == SteamVR.InitializedStates.InitializeSuccess;
//#endif
//                _buttonMappingsFloat = new Dictionary<InputFeatureUsage<float>, string>();
//                _buttonMappingsBool = new Dictionary<InputFeatureUsage<bool>, string>();
//                _buttonMappings2D = new Dictionary<InputFeatureUsage<Vector2>, string>();

//                _buttonMappingsFloat.Add(CommonUsages.trigger, "TriggerPull");
//                _buttonMappingsBool.Add(CommonUsages.triggerButton, "TriggerClick");
//                _buttonMappingsFloat.Add(CommonUsages.grip, "GripPull");
//                _buttonMappingsBool.Add(CommonUsages.gripButton, "GripClick");
//                _buttonMappingsBool.Add(CommonUsages.primaryButton, "PrimaryClick");
//                _buttonMappingsBool.Add(CommonUsages.primaryTouch, "PrimaryTouch");
//                _buttonMappingsBool.Add(CommonUsages.secondaryButton, "SecondaryClick");
//                _buttonMappingsBool.Add(CommonUsages.secondaryTouch, "SecondaryTouch");
//                _buttonMappingsBool.Add(CommonUsages.menuButton, "MenuClick");
//                _buttonMappings2D.Add(CommonUsages.primary2DAxis, "Primary2DAxis");
//                _buttonMappingsBool.Add(CommonUsages.primary2DAxisClick, "Primary2DAxisClick");
//                _buttonMappingsBool.Add(CommonUsages.primary2DAxisTouch, "Primary2DAxisTouch");
//                _buttonMappings2D.Add(CommonUsages.secondary2DAxis, "Secondary2DAxis");
//                _buttonMappingsBool.Add(CommonUsages.secondary2DAxisClick, "Secondary2DAxisClick");
//                _buttonMappingsBool.Add(CommonUsages.secondary2DAxisTouch, "Secondary2DAxisTouch");
//            }
//        }
